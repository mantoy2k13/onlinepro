 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Models\UserNotification whereTitle($value)
...
class Notification extends Base
{
    ...
    const CATEGORY_TYPE_BOOKING        = 'booking';
    const CATEGORY_TYPE_CANCEL         = 'cancel';
    const CATEGORY_TYPE_PURCHASE       = 'purchase';
    const CATEGORY_TYPE_EXPIRE         = 'expire';

    const TYPE_GENERAL_MESSAGE = 'general_message';
    const TYPE_GENERAL_ALERT   = 'general_alert';
    const TYPE_BOOKING_ALERT   = 'booking_alert';
    const TYPE_POINT_ALERT     = 'point_alert';
