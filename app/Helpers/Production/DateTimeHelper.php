...
class DateTimeHelper implements DateTimeHelperInterface
{
    ...
    public function nowInPresentationTimeZone()
    {
        return $this->now(new \DateTimeZone(config('app.default_presentation_timezone')));
    }

    public function createTimeFromString($dateTimeString)
    {
        return Carbon::parse($dateTimeString, $this->timezoneForPresentation());
    }
