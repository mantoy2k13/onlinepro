...
class CityController extends Controller
{
    ...
    public function index(PaginationRequest $request)
    {
        ...
        $count       = $this->cityRepository->countEnabledWithConditions($nameJa, $nameEn, $countryCode);
        $models      = $this->cityRepository->getEnabledWithConditions($nameJa, $nameEn, $countryCode, 'updated_at', 'desc', $offset, $limit);
