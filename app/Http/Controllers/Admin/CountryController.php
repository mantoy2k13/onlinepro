...
class CountryController extends Controller
{
    ...
    public function index(PaginationRequest $request)
    {
        ...
        $count       = $this->countryRepository->countEnabledWithConditions($nameJa, $nameEn, $countryCode);
        $models      = $this->countryRepository->getEnabledWithConditions($nameJa, $nameEn, $countryCode, 'updated_at', 'desc', $offset, $limit);
    ...
    public function store(CountryRequest $request)
    {
        ...
        $input = $request->only(['code', 'name_en', 'name_ja', 'order']);
