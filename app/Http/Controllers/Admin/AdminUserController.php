...
class AdminUserController extends Controller
{
    ...
    public function store(AdminUserUpdateRequest $request)
    {
        ...
        return redirect()->action('Admin\AdminUserController@show', [$adminUser->id])->with(
            'message-success',
    ...
    public function update($id, AdminUserUpdateRequest $request)
    {
        ...
        return redirect()->action('Admin\AdminUserController@show', [$id])->with(
            'message-success',
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action('Admin\AdminUserController@index')->with(
            'message-success',
