...
//        \App\Http\Middleware\SecurePath::class,
    ...
    protected $routeMiddleware = [
        ...
        'teacher.auth'              => \App\Http\Middleware\Teacher\Authenticate::class,
        'teacher.guest'             => \App\Http\Middleware\Teacher\RedirectIfAuthenticated::class,
        'teacher.values'            => \App\Http\Middleware\Teacher\SetDefaultValues::class,
    ];
}
