            ...
            <form action="{{ action('Admin\CountryController@index') }}" method="get">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name_ja" class="form-control" id="name_ja" placeholder="@lang('admin.pages.countries.columns.name_ja')" value="{{ $nameJa }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
    ...
    <div class="box-body">
        <table class="table table-bordered">
            <tr>
                ...
                <th>@lang('admin.pages.countries.columns.name_ja')</th>
